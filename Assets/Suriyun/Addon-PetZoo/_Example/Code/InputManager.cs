...
namespace Suriyun.PetZoo
{
    public class InputManager : MonoBehaviour
    {
        ...
        protected virtual void HandleMouse0() {
            ...
            if (Mouse.current.leftButton.isPressed && (EventSystem.current == null || !EventSystem.current.IsPointerOverGameObject())) {
                done = false;
                tmp_distance = 0f;
                ray = main_camera.ScreenPointToRay(Mouse.current.position.ReadValue());
        ...
        public virtual void AddAllController() {
            ControllerPetZoo[] tmp = Object.FindObjectsByType<ControllerPetZoo>(FindObjectsSortMode.None);
